    ...
    methods: {
        ...
        encode: function(bits){
            ...
            if(bits.length === 4){
                ...
                var c0= this.parity(parseInt(bits[0].data)+parseInt(bits[1].data)+parseInt(bits[2].data)+parseInt(bits[3].data) + c1 + c2 + c4); // se calculeaza bitul de control de pe pozitia 0
                console.log("Control bits: "+c1+","+c2+","+c4);
                console.log("Parity: "+ c0);
                ...
                var c0= this.parity(parseInt(bits[0].data)+parseInt(bits[1].data)+parseInt(bits[2].data)+parseInt(bits[3].data)+parseInt(bits[4].data)+parseInt(bits[5].data)+parseInt(bits[6].data)+parseInt(bits[7].data) + c1 + c2 + c4 + c8); // se calculeaza bitul de control de pe pozitia 0
